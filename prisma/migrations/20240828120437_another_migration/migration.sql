...
-- AddForeignKey
ALTER TABLE "IncomingTransaction" ADD CONSTRAINT "IncomingTransaction_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
